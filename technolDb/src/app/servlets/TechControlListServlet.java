...
@WebServlet("/techControlList")
public class TechControlListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		...
		List<TechControl> resultList=null;
		try{
		resultList = techControlDAO.selectAllTechControls(operId);
		}
		catch(SQLException e){response.getWriter().println(e);}
		...
		request.setAttribute("techControlList", resultList);
		
		RequestDispatcher dispatcher = request.getServletContext()
	                .getRequestDispatcher("/WEB-INF/views/techControlListView.jsp");
