...
<html>
   <head>
      <meta charset="UTF-8">
      <title>Новый тех.переход</title>
   </head>
   <body>     
      <h3>Добавить новый технологический переход</h3>
       
      <form method="POST" action="${pageContext.request.contextPath}/createTechTransit">
         ...
         <table border="0">
            <tr>
               ...
               <td><input type="text" name="transitNum"  /></td>
            </tr>
            <tr>
               <td>Содержание перехода</td>
               <td><input type="text" name="transitCont" /></td>
            </tr>
            <tr>
               <td>Вспомогательный инструмент</td>
               <td><input type="text" name="subsidTool" /></td>
            </tr>
            <tr>
               <td>Режущий инструмент</td>
               <td><input type="text" name="cutTool" /></td>
            </tr>
            <tr>
               <td>Измерительный инструмент</td>
               <td><input type="text" name="measTool" /></td>
            </tr>
           <tr>
            ...
            <tr>
               ...
               <td><input type="text" name="numOfSteps" /></td>
            </tr>
            <tr>
			...
			<tr>
               ...
               <td><input type="text" name="rotSpeed" /></td>
            </tr> 
            <tr>
               <td>Скорость резания (V), мм/мин</td>
               <td><input type="text" name="cutSpeed" /></td>
            </tr> 
            <tr>
               <td colspan="2">                   
